...
# remove the init scripts, we're shipping a systemd unit
rm -rf etc/init.d
...
# Install logrotate
install -p -D -m 644 %{SOURCE0} %{buildroot}%{_sysconfdir}/logrotate.d/openstack-%{pypi_name}
