...
Source0:        openstack-tacker-server.service
...
mv %{buildroot}/usr/etc/rootwrap.d %{buildroot}%{_sysconfdir}/%{pypi_name}
...
install -p -D -m 644 %{SOURCE0} %{buildroot}%{_unitdir}/openstack-%{pypi_name}-server.service
