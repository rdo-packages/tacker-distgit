...
mv %{buildroot}/usr/etc/%{service}/* %{buildroot}%{_sysconfdir}/%{pypi_name}
mv %{buildroot}%{_sysconfdir}/%{service}/api-paste.ini %{buildroot}%{_sysconfdir}/%{pypi_name}/api-paste.ini
...
HOMEDIR=%{_sharedstatedir}/%{pypi_name}
